...
$(document).ready(function () {
  ...
  $('#calculer').on('click', function () {
    ...
    if (signe == '+') {
      resultat = $('#message').html(
        '<div style="background-color: pink;color: yellow; text-align: center;font-size:26px; padding:20px">Résultat addition: ' +
          value1 +
          signe +
          value2 +
          ' = ' +
      ...
      resultat = resultat = $('#message').html(
        '<div style="background-color: pink;color: yellow; text-align: center;font-size:26px; padding:20px">Résultat soustration: ' +
          value1 +
          signe +
          value2 +
          ' = ' +
      ...
      resultat = resultat = $('#message').html(
        '<div style="background-color: pink;color: yellow; text-align: center;font-size:26px; padding:20px">Résultat multiplication: ' +
          value1 +
          signe +
          value2 +
          ' = ' +
      ...
      resultat = resultat = $('#message').html(
        '<div style="background-color: pink;color: yellow; text-align: center;font-size:26px; padding:20px">Résultat division: ' +
          value1 +
          signe +
          value2 +
          ' = ' +
  ...
  $('#nombre1, #nombre2').on('mouseover', function () {
    $('#message').html(
      `<div style="background-color: pink;color: red; padding:20px">Saisir un chiffre</div>`
    );
  });
  ...
  $('#operateur').on('mouseover', function () {
    $('#message').html(
      `<div style="background-color: pink;color: red; padding:20px">Saisir un opérateur + - / *</div>`
    );
  });
